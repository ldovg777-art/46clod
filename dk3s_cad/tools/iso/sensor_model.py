...
# шайба пружинная (гровер) 20 65Г ГОСТ 6402-70, нормальная: d 20,5, s = b = 5 — между грундбуксой и гайкой.
...
# грундбукса сдвинута на толщину шайбы, буртик втулки в модели короче (поджат).
GROVER_D, GROVER_S, GROVER_B = 20.5, 5.0, 5.0
...
def build():
    ...
    x_c0 = Z_LAND_END + 0.3                        # начало конуса буртика (зазор к седлу)
    x_c1 = x_c0 + (rc - rn) / T60
    x_c2 = x_g1 - 0.3
